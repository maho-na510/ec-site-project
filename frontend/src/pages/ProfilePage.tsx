      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold text-secondary-900 mb-6">個人情報</h2>
            ...
            <div className="space-y-4">
              ...
              {userInfo.phone && (
                <div>
                  ...
                  <p className="text-secondary-900">{userInfo.phone}</p>
                </div>
              )}
              ...
              {userInfo.address && (
                <div>
                  ...
                  <p className="text-secondary-900">{userInfo.address}</p>
                </div>
              )}

              <div>
                <label className="text-sm font-medium text-secondary-600">登録日</label>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold text-secondary-900 mb-6">注文履歴</h2>
      ...
      {isExpanded && (
        <div className="p-4 border-t border-secondary-200">
          {order.shippingAddress && (
            <div className="mb-4">
              <h4 className="text-sm font-medium text-secondary-700 mb-1">配送先住所</h4>
              <p className="text-sm text-secondary-600">{order.shippingAddress}</p>
            </div>
          )}

          {order.items && order.items.length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-secondary-700 mb-3">注文商品</h4>
